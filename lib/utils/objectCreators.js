...
const declaredVersionMatch = (pjson.devDependencies?.cypress || '').match(/\d+\.\d+\.\d+/);
const declaredVersion = declaredVersionMatch ? declaredVersionMatch[0] : '';

const getInstalledCypressVersion = () => {
  try {
...
const frameworkVersion = getInstalledCypressVersion() || declaredVersion;
...
const getTestEndObject = (testInfo) => {
