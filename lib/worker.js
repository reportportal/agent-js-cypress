...
process.on('message', (message) => {
  ...
  switch (event) {
    ...
    case reporterEvents.SCREENSHOT: {
      const screenshotInfo = message.screenshotInfo;
      const logMessage = screenshotInfo.logMessage;
      delete screenshotInfo.logMessage;
      reporter.sendScreenshot(screenshotInfo, logMessage);
      break;
    }
